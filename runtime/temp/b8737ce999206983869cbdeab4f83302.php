<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"E:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin/view/default/property\edit.html";i:1552626194;s:89:"E:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <label class="textarea" id="content">
                <textarea name="parse"><?php echo (isset($info['parse']) && ($info['parse'] !== '')?$info['parse']:''); ?></textarea>
