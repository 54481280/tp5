...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="__PUBLIC__/image/index.png" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="<?php echo url('Article/articleList'); ?>?class='小区通知'">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Article/articleList'); ?>?class='便民服务'">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Property/index'); ?>">
