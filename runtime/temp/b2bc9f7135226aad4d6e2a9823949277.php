<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin/view/default/news\index.html";i:1552706341;s:89:"E:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <table>
				...
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$property): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('index?pid='.$property['id']); ?>"><?php echo $property['title']; ?></a>
                        </td>
                        <td><?php echo $property['name']; ?></td>
                        <td><?php echo $property['phone']; ?></td>
                        <td><?php echo $property['add_time']; ?></td>
                        <td>
