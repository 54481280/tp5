...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '=!.jqQ`)/"d[76C-orFiJ(kB%tybcOmn_XA8KTR2', //默认数据加密KEY
	'data_cache_key'=> '=!.jqQ`)/"d[76C-orFiJ(kB%tybcOmn_XA8KTR2',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'=!.jqQ`)/"d[76C-orFiJ(kB%tybcOmn_XA8KTR2', //加密KEY
